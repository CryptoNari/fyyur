...
def venues():
  ...
  for area in areas:
    venues = (
      Venue.query.filter_by(city=area.city, state=area.state)
        .order_by(Venue.name)
        .all()
    )
...
def edit_artist_submission(artist_id):
  ...
  try:
    ...
    db.session.close()    
  if error:
    flash('A Problem occured. Artist ' + request.form['name'] + ' was not updated!')
  else:
...
def create_artist_submission():
  ...
  try:
    ...
    db.session.close()    
  if error:
    flash('A Problem occured. Artist ' + request.form['name'] + ' was not listed!')
  else:
